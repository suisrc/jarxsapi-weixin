...
import com.suisrc.weixin.mp.msg.event.ClickEvent;
import com.suisrc.weixin.mp.msg.event.LocationEvent;
import com.suisrc.weixin.mp.msg.event.QrsceneEvent;
import com.suisrc.weixin.mp.msg.event.QrsceneSubscribeEvent;
import com.suisrc.weixin.mp.msg.event.SubscribeEvent;
import com.suisrc.weixin.mp.msg.event.UnsubscribeEvent;
import com.suisrc.weixin.mp.msg.event.ViewEvent;
import com.suisrc.weixin.mp.msg.event.WxEventMessage;
import com.suisrc.weixin.mp.msg.msg.ImageMessage;
import com.suisrc.weixin.mp.msg.msg.LinkMessage;
import com.suisrc.weixin.mp.msg.msg.LocationMessage;
import com.suisrc.weixin.mp.msg.msg.ShortvideoMessage;
import com.suisrc.weixin.mp.msg.msg.TextMessage;
import com.suisrc.weixin.mp.msg.msg.VideoMessage;
...
public enum WxMsgType {
    ...
    /**
     * 用户未关注时，进行关注后的事件推送 如果用户还未关注公众号，则用户可以关注公众号，关注后微信会将带场景值关注事件推送给开发者。
     */
    event_subscribe_qrscene("二维码订阅事件", QrsceneSubscribeEvent.class),

    /**
     * 用户已关注时的事件推送 如果用户已经关注公众号，则微信会将带场景值扫描事件推送给开发者。
     */
